...
<div class="container pt">
    ...
    <div class="row mt">
        <div class="col-lg-8 col-lg-offset-2">
            <form role="form" action="index.php?id=<?= $id ?>&action=ajoutcom" method="post">
                <div class="form-group">
                    <?php
                    if(isset($_SESSION['role']) && $_SESSION['role'] == 'admin'){
                        echo '<p><input placeholder="Pseudonyme" class="form-control" type="text" name="auteur" id="auteur" value="'.$_SESSION['login'].'" readonly/></p>';
                    }
                    else
                        echo '<p><input placeholder="Pseudonyme" class="form-control" type="text" name="auteur" id="auteur" value="'.$_SESSION['login'].'"/></p>';
                    ?>
                    <br>
                </div>
                <textarea name="commentaire" id="commentaire" class="form-control" rows="6" placeholder="Commentaire..."></textarea>
                <br>
