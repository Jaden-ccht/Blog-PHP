...
<div class="container pt">
    ...
    <div class="row mt">
        <div class="col-lg-8 col-lg-offset-2">
            <form role="form" action="index.php?action=ajoutnews" method="post">
                <div class="form-group">
                    <p><input placeholder="Titre de l'article" class="form-control" type="text" name="titre" id="titre"/></p>
                    <br>
                </div>
                <textarea name="contenu" id="contenu" class="form-control" rows="6" placeholder="Contenu de l'atricle"></textarea>
                <br>
